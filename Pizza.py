...
#--  page 1------
    def main(sf):
        ...
        sf.lab=Button(sf.mainf2,text= "Click Here to Enter my store",command=lambda:sf.Login(),cursor="hand2", bd=10 ,font=("algerian",30, 'bold'),fg="white",bg="#0b1335")
...
#------ page 2------
    def Login(sf):
        ...
        sf.home=Button(sf.loginf1,text="Home",command=lambda:sf.main(),bg="#0b1335",cursor="hand2",bd=4,fg="white",font=("algerian",16))
        sf.home.place(x=800,y=100)
        sf.adlog=Button(sf.loginf1,text="Administrator Login",command=lambda:sf.Adminlogin(),cursor="hand2",bd=4,bg="#0b1335",fg="white",font=("algerian",16))
        sf.adlog.place(x=925,y=100)
        sf.abt=Button(sf.loginf1,text="About Us",bg="#0b1335",cursor="hand2",bd=4,fg="white",font=("algerian",16))
        ...
        sf.log=Label(sf.loginf2,text="LOGIN",fg="white",bg="#0b1335",width=26,font=("algerian",27))
        sf.log.place(x=59,y=105)
        sf.lab1=Label(sf.loginf2,text="UserName",bg="#d3ede6",font=("algerian",22))
        sf.lab1.place(x=100,y=180)
        sf.user=Entry(sf.loginf2,bg="white",font=("algerian",22),bd=6 ,justify='left')
        sf.user.place(x=320,y=180)
        sf.lab2=Label(sf.loginf2,text="Password",bg="#d3ede6",font=("algerian",22))
        sf.lab2.place(x=105,y=250)
        sf.pasd=Entry(sf.loginf2,bg="white",font=("algerian",22),bd=6 ,justify='left')
        sf.pasd.place(x=320,y=250)
        sf.lg=Button(sf.loginf2,text="Login",cursor="hand2",command=lambda:sf.logindatabase(),fg="white",bg="#0b1335",font=("algerian",20),bd=4)
        sf.lg.place(x=180,y=320)
        def clear(sf):
            sf.user.delete(0,END)
            sf.pasd.delete(0,END)
        sf.cl=Button(sf.loginf2,text="Clear",cursor="hand2",command=lambda:clear(sf),fg="white",bg="#0b1335",font=("algerian",20),bd=4)
    ...
    def about(sf):
        sf.scr1=Tk()
        sf.L=Label(sf.scr1,text="NEW PIZZA SHOP At Dubai")
        sf.L.pack()
        sf.scr1.mainloop()
#--  page 3------
    def Adminlogin(sf):
...
#--  page 4------
    def Register(sf):
        ...
        def clear(sf):
            ...
            sf.mob.delete(0,END)
        sf.cl=Button(sf.regf2,text="Clear",cursor="hand2",fg="white",bg="#0b1335",command=lambda:clear(sf),font=("algerian",18),bd=5)
...
##            sf.randomRef = str(sf.x)
        ...
        sf.lbl3 = Label(sf.admainf2,pady=2, font=( 'algerian' ,20, 'bold','underline' ),bg="#f2e8b8",text="Specialty",bd=10,anchor='w')
        sf.lbl3.place(x=550,y=0)
        sf.lbl31 = Label(sf.admainf2,pady=2, font=( 'algerian' ,16,'underline' ),width=6,bg="#f2e8b8",text="Items",bd=6,anchor='w')
        sf.lbl31.grid(row=1,column=4)
        sf.lbl33 = Label(sf.admainf2,pady=2, font=( 'algerian' ,16,'underline' ),width=8,bg="#f2e8b8",text="Quantity",bd=6,anchor='w')
        ...
        sf.lbl4 = Label(sf.admainf2,pady=2, font=( 'algerian' ,20, 'bold','underline' ),bg="#f2e8b8",text="Sides & Beverages",bd=10,anchor='w')
        sf.lbl4.place(x=500,y=290)
        sf.lbl41 = Label(sf.admainf2,pady=2, font=( 'algerian' ,16,'underline' ),width=6,bg="#f2e8b8",text="Items",bd=6,anchor='w')
        sf.lbl41.grid(row=7,column=4)
        sf.lbl43 = Label(sf.admainf2,pady=2, font=( 'algerian' ,16,'underline' ),width=8,bg="#f2e8b8",text="Quantity",bd=6,anchor='w')
...
#--  page 8------
    def vegpizza(sf,x):
        ...
        sf.c.create_text(650,80,text="Deluxe Veggie",fill="#000000",font=("algerian",20))
        ...
        sf.c.create_text(650,200,text="Veg Vaganza",fill="#000000",font=("algerian",20))
...
##        ch2=sf.check(sf.vegf2,220)
        ...
        sf.c.create_text(650,320,text="5 Pepper",fill="#000000",font=("algerian",20))
        ...
        sf.c.create_text(650,440,text="Margherita",fill="#000000",font=("algerian",20))
...
#--  page 10------
    def nonvegpiz(sf,x):
        ...
        sf.logo1=PhotoImage(file="pizzamain.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.log=Label(sf.nonvegf2,text="NON-VEG PIZZA",bg="#9db1f2",font=("algerian",22))
        ...
        sf.c.create_image(470,110,image=sf.delu)
        sf.c.create_text(650,80,text="Non-Veg Supreme",fill="#000000",font=("algerian",20))
        sf.c.create_text(860,80,text="₹450/₹650/₹250",fill="#ff3838",font=("default",17,'bold'))
        ...
        sf.c.create_image(470,230,image=sf.vag)
        sf.c.create_text(650,200,text="Chicken Tikka",fill="#000000",font=("algerian",20))
        sf.c.create_text(860,200,text="₹400/₹600/₹250",fill="#ff3838",font=("default",17,'bold'))
        ...
        sf.c.create_image(470,350,image=sf.pep)
        sf.c.create_text(650,320,text="Chicken Sausage",fill="#000000",font=("algerian",20))
        sf.c.create_text(860,320,text="₹385/₹550/₹225",fill="#ff3838",font=("default",17,'bold'))
        ...
        sf.c.create_image(470,470,image=sf.mag)
        sf.c.create_text(650,440,text="Chicken Peri",fill="#000000",font=("algerian",20))
        sf.c.create_text(860,440,text="₹195/₹385/₹99",fill="#ff3838",font=("default",17,'bold'))
...
#--  page 11------
    def SpecialChi(sf,x):
        ...
        sf.logo1=PhotoImage(file="pizzamain.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.log=Label(sf.spef2,text="SPECIALTY CHICKEN",bg="#9db1f2",font=("algerian",22))
        ...
        sf.c.create_image(470,110,image=sf.delu)
        sf.c.create_text(650,80,text="Roasted Chicken",fill="#000000",font=("algerian",20))
        ...
        sf.c.create_image(470,230,image=sf.vag)
        sf.c.create_text(650,200,text="Chicken Meatballs",fill="#000000",font=("algerian",20))
        ...
        sf.c.create_image(470,350,image=sf.pep)
        sf.c.create_text(650,320,text="Boneless Chicken",fill="#000000",font=("algerian",20))
...
#--  page 12------
    def sidebev(sf,x):
        ...
        sf.logo1=PhotoImage(file="pizzamain.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.log=Label(sf.sidef2,text="SIDES & BEVERAGES",bg="#9db1f2",font=("algerian",22))
        ...
        sf.c.create_image(470,110,image=sf.delu)
        sf.c.create_text(650,80,text="Coke Mobile",fill="#000000",font=("algerian",20))
        ...
        sf.c.create_image(470,230,image=sf.vag)
        sf.c.create_text(650,200,text="Burger Pizza",fill="#000000",font=("algerian",20))
        sf.c.create_text(875,200,text="₹99",fill="#ff3838",font=("default",17,'bold'))
        sf.c.create_text(590,240,text="Quantity : ",fill="#000000",font=("default",12))
        ...
        sf.c.create_image(470,350,image=sf.pep)
        sf.c.create_text(650,320,text="White Pasta",fill="#000000",font=("algerian",20))
...
#--  page 14------
 ...
 #-----  database-------               
    ...
    def orderpay(sf,x):
        ...
        messagebox.showinfo("Pay","Payment is not available now")
